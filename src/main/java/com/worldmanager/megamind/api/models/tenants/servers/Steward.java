...
@DiscriminatorValue(Role.Constants.STEWARD_VALUE)
@JsonTypeName(Role.Constants.STEWARD_VALUE)
@TypeAlias(value = Role.Constants.STEWARD_VALUE)
public class Steward extends Server {
